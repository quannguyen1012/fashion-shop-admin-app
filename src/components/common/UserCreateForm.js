  ...
  <div className ="form-wrapper" >  
    ...
    >
      ...
      <Form.Item  
        ...
        />
        {user.fullname.trim() === "" && <p style={{ color: "red" }}>{error.fullname}</p>}
      </Form.Item>
      <Form.Item label="Username">
        ...
        />
        {user.username.trim() === "" && <p style={{ color: "red" }}>{error.username}</p>}
      </Form.Item>
            <Form.Item 
        label="Password"
        rules={[
      ...
      >
        <Input
          ...
          />
          {user.password.trim() === "" && <p style={{ color: "red" }}>{error.password}</p>}
      </Form.Item>
      <Form.Item
      rules={[
        {
      ...
      label="Email">
        ...
        />
        {user.email.trim() === "" && <p style={{ color: "red" }}>{error.email}</p>}
      </Form.Item>
